...
export class CategoryResult {
    ...
    public constructor(name: string, url: string, isScanner: boolean) {
        ...
        this.image = categoryImages[name.toLowerCase()] || categoryImages[Category.other.toLowerCase()];
...
export default class AnalysisResult {
     ...
     * @param problem New suggestion.
     * @param hintCategoryName, defined categoryName for Hint
     */
    public addProblem(problem: Problem, hintCategoryName:string): void {
        const categoryName: string = hintCategoryName || problem.category;
